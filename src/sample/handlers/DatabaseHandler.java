...
public class DatabaseHandler {
    ...
    public static Connection getConnection() throws SQLException {
        ...
        try{
            ...
            String url = "jdbc:hsqldb:file:" + System.getProperty("user.home") + "\\Documents\\ReportWriter\\;shutdown=true;ifexists=true";
            ...
            String url = "jdbc:hsqldb:file:" + System.getProperty("user.home") + "\\Documents\\ReportWriter\\;shutdown=true";
            con = DriverManager.getConnection(url, "nour", "268953");
            statement = con.createStatement();
            result = statement.executeUpdate("CREATE TABLE user (\n" +
                    ...
                    "    level int NOT NULL\n" +
                    "    );");
            result = statement.executeUpdate("CREATE TABLE customer (\n" +
                    "    id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n" +
                    "    name nvarchar(50) NOT NULL,\n" +
                    "    testplace nvarchar(50) NOT NULL\n" +
                    "    );");
            result = statement.executeUpdate("CREATE TABLE joborderno (\n" +
                    "    number nvarchar(50) NOT NULL,\n" +
                    "    customerid INTEGER, \n" +
                    "    FOREIGN KEY (customerid) REFERENCES customer(id)\n" +
                    "    );");
            result = statement.executeUpdate("CREATE TABLE projectname (\n" +
                    "    name nvarchar(50) NOT NULL,\n" +
                    "    customerid INTEGER, \n" +
                    "    FOREIGN KEY (customerid) REFERENCES customer(id)\n" +
                    "    );");
            result = statement.executeUpdate("CREATE TABLE offerno (\n" +
                    "    number nvarchar(50) NOT NULL,\n" +
                    "    customerid INTEGER, \n" +
                    "    FOREIGN KEY (customerid) REFERENCES customer(id)\n" +
                    "    );");
            result = statement.executeUpdate("CREATE TABLE equipment (\n" +
                    "    id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n" +
                    "    poleDistance real NOT NULL,\n" +
                    "    equipment nvarchar(50) NOT NULL,\n" +
                    "    MPCarrierMedium nvarchar(50) NOT NULL,\n" +
                    "    magTech nvarchar(50) NOT NULL,\n" +
                    "    UVLightIntensity nvarchar(50) NOT NULL,\n" +
                    "    distanceOfLight nvarchar(50) NOT NULL\n" +
                    "    );");
            result = statement.executeUpdate("CREATE TABLE SurfaceCondition (\n" +
                    "    id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n" +
                    "    condition nvarchar(50) NOT NULL\n" +
                    "    );");
            result = statement.executeUpdate("CREATE TABLE StageOfExamination (\n" +
                    "    id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n" +
                    "    stage nvarchar(50) NOT NULL\n" +
                    "    );");
            result = statement.executeUpdate("INSERT INTO USER (username, password, name, surname, level) " +
                    "VALUES  ('admin', -1861353340, 'admin', 'admin', 3)");
        }
        return con;
    }
